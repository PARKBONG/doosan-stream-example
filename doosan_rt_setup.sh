...
# rosservice call /$ROBOT_NS/system/set_safety_mode "{safety_mode: 1, safety_mode_event: 10}"

# rosservice call /$ROBOT_NS/realtime/connect_rt_control "{}"
rosservice call /dsr01m1013/realtime/connect_rt_control "{ip_address: '192.168.137.100', port: 12345}"
...
# rosservice call /dsr01m1013/realtime/rt_connect